...
<style>
    ...
    .text-content h3 {
        font-size: 3em; /* Aumenta el tama�o del t�tulo principal */
    }
    .text-content h4 {
        font-size: 2em; /* Aumenta el tama�o de los subt�tulos */
        text-align: center;
    }
    .image-row {
        display: flex;
    ...
    .image-row img {
        max-width: 230px; /* Ajusta el tama�o de ambas im�genes */
    }
</style>
</head>
<body>
