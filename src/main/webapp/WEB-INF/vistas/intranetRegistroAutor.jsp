	 ...
	 <div class="col-md-12" style="margin-top: 2%">
			<div class="row">
				<div class="form-group col-md-3">
					...
					<input class="form-control" type="text" id="id_nombres" name="nombres" placeholder="Ingrese nombre">
				</div>
				<div class="form-group col-md-3">
					<label class="control-label" for="id_apellidos">Apellidos</label>
					<input class="form-control" type="text" id="id_apellidos" name="apellidos" placeholder="Ingrese apellido ">
				</div>
				<div>
				<div class="col-sm-4">
			...
			<div class="form-group col-md-3">
			    ...
			    <div class="form-group col-md-3">
					...
					<select id="id_grado" name="pais.idGrado" class='form-control'>
						<option value=" ">[Seleccione]</option>    
					</select>
			    </div>
			</div>
